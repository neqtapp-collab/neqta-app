...
describe('custos de insumos', () => {
  ...
  it.todo('persiste o custo efetivo como referência oficial da ficha técnica');
...
describe('unidades e composição', () => {
  ...
  it.todo('exige conteúdo interno para converter caixa ou pacote em unidades-base');
  it.todo('rejeita conversões entre dimensões incompatíveis em vez de manter o custo silenciosamente');
});
