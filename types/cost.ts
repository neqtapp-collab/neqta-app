...
export type Supplier = { id: string; name: string; contact?: string; phone?: string; email?: string; notes?: string; active?: boolean };
export type PriceHistory = { id: string; date: string; price: number; unitCost: number };
export type ProductCostRelation = { productId: string; name: string; category: string; margin: number; quantity?: number; unit?: string };
